...
const char *fragment_shader_glsl_pr =
 ...
 "{"
   ...
   "float r=sphereSDF(v,vec3(0.,10-sin(T.x/10.)*3.-sin(T.z/10.),0),4.),f=sphereSDF(v,vec3(-5.,10.-sin(T.x/10.)*3.-sin(T.z/10.)*3.,0.),2.),i=sphereSDF(v,vec3(0.,10.-sin(T.x/10.)*3.-sin(T.z/10.)*3.,5.),2.),a=sphereSDF(v,vec3(0.,10.-sin(T.x/10.)*3.-sin(T.z/10.)*3.,-5.),2.),m=sphereSDF(v,vec3(5.,10.-sin(T.x/10.)*3.-sin(T.z/10.)*3.,0.),2.),l=opSmoothUnion(r,f,sin(TIME)*2.+2.),t=opSmoothUnion(i,a,sin(TIME)*2.+2.);"
 ...
 "{"
   ...
   "vec3 f=s+n.x*v.left*r+n.y*v.up;"
 ...
 "{"
   ...
   "float f=pow(max(0.,dot(i,v.rayDir)),200.);"
   "color.xyz+=vec3(f)*T.diffuse_color;"
 "}";
